...
class Application(Base):
    ...
    ai_prep_note = relationship("AIPrepNote", back_populates="application", uselist=False, cascade="all, delete-orphan")

    __table_args__ = (
        UniqueConstraint("user_id", "company_id", "role_title", name="uq_user_company_role"),
